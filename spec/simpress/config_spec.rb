  ...
  describe "initialize" do
    context "正常な設定ファイルを指定した場合" do
      it "successful" do
        ...
        expect(Simpress::Config.instance.mode).to eq("html")
      end
    end
    ...
    context "設定ファイルが存在しない場合" do
      it "例外が発生すること" do
        ...
        expect { Simpress::Config.instance }.to raise_error(Errno::ENOENT)
      end
    end
    ...
    context "Psych.load_fileがnilを返した場合" do
      it "不正値として例外が発生すること" do
        ...
        expect { Simpress::Config.instance }.to raise_error(CH::SchemaViolationError)
      end
    end
  end
end
